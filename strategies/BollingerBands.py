...
def fetch_and_analyze_bollinger_bands(stock_ticker, start_date, end_date, initial_capital=100000, window=5, num_std_dev=1):
    # 抓取股票數據
    ...
    print(data[['Close', 'Moving Average', 'Upper Band', 'Lower Band', 'Signal']].tail(20))  # 顯示最後20筆記錄
    print("\n--- Performance Metrics ---")
